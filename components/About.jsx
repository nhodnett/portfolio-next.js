    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                <p className='uppercase text-xl tracking-widest text-[#077187]'>About</p>
                ...
                <p className='py-2 text-gray-600'>Overall, my background in business development, sales, and coaching, combined with my education 
